...
class Interceptor extends \ScandiPWA\Customization\View\Result\Page implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function getThemeConfiguration(string $sectionName)
    {
        ...
        if (!$pluginInfo) {
            return parent::getThemeConfiguration($sectionName);
        } else {
            return $this->___callPlugins('getThemeConfiguration', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getStoreListJson()
    {
        ...
        if (!$pluginInfo) {
            return parent::getStoreListJson();
        } else {
            return $this->___callPlugins('getStoreListJson', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getStaticFile');
        if (!$pluginInfo) {
            return parent::getStaticFile($url);
        } else {
            return $this->___callPlugins('getStaticFile', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getStaticBundleFile');
        if (!$pluginInfo) {
            return parent::getStaticBundleFile();
        } else {
            return $this->___callPlugins('getStaticBundleFile', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function setAction(string $actionType)
    {
        ...
        if (!$pluginInfo) {
            return parent::setAction($actionType);
        } else {
