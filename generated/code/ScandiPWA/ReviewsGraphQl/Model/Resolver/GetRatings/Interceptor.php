...
class Interceptor extends \ScandiPWA\ReviewsGraphQl\Model\Resolver\GetRatings implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\Store\Model\StoreManagerInterface $storeManager, \Magento\Review\Model\ResourceModel\Rating\CollectionFactory $ratingCollectionFactory)
    {
        $this->___init();
        parent::__construct($storeManager, $ratingCollectionFactory);
    }
