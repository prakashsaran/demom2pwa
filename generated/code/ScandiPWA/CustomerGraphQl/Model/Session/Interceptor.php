...
class Interceptor extends \ScandiPWA\CustomerGraphQl\Model\Session implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getDefaultTaxShippingAddress');
        if (!$pluginInfo) {
            return parent::getDefaultTaxShippingAddress();
        } else {
            return $this->___callPlugins('getDefaultTaxShippingAddress', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getDefaultTaxBillingAddress');
        if (!$pluginInfo) {
            return parent::getDefaultTaxBillingAddress();
        } else {
            return $this->___callPlugins('getDefaultTaxBillingAddress', func_get_args(), $pluginInfo);
        }
    }
